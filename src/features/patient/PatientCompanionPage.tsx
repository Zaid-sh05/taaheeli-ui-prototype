...
const quickActions: QuickAction[] = [
  ...
  },
  {
    ...
    companionResponse:
      "يمكنك التواصل مع المركز عن طريق الاتصال على الرقم الموفر لك، أو الذهاب إلى صفحة المواعيد لطلب موعد. في حالة الطوارئ اتصل بالرقم 999 فوراً.",
  },
];
  ...
  function handleSendCustom() {
    ...
    setTimeout(() => {
      sendCompanionMessage(
        "شكراً لمشاركتك. أنا مرافق تجريبي ولا أستطيع تقديم نصائح طبية. لمزيد من المساعدة يرجى التواصل مع مركزك العلاجي. في حالة الطوارئ اتصل بالرقم 999.",
        "companion",
      );
    }, 600);
  }
    ...
    <PageContainer maxWidth="max-w-2xl" className="py-8">
      ...
      <Alert tone="warning" className="mb-6">
        ...
        <p className="leading-relaxed">
          هذا المرافق تجريبي ولا يغني عن الاستشارة الطبية. في حالة الطوارئ اتصل بالرقم 999
        </p>
      </Alert>
